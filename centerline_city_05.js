...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:11.4,alpha:0},29,cjs.Ease.quadOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({y:146},29,cjs.Ease.quadOut).wait(11));

	// House_2_on_png
	this.instance_1 = new lib.house_02_anim();
	this.instance_1.setTransform(375.5,341,1,1,0,0,0,112.5,101);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:249},29,cjs.Ease.quadOut).wait(16));

	// House_1_on_png
	this.instance_2 = new lib.house_01_anim();
	this.instance_2.setTransform(617,192,1,1,0,0,0,109,105);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(15).to({y:100},29,cjs.Ease.quadOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({y:3.5},29,cjs.Ease.quadOut).wait(6));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-38.1,alpha:0},29,cjs.Ease.quadOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:164.75,alpha:0},29,cjs.Ease.quadInOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// powerlines_OFF
	this.instance_9 = new lib.Powerlines_OFF();
	this.instance_9.setTransform(16,12);
...
p.nominalBounds = new cjs.Rectangle(1,0,2306,900);
...
}).prototype = getMCSymbolPrototype(lib.Powerlines_mc, new cjs.Rectangle(16,12,2285,866), null);
...
// stage content:
(lib.centerline_city_05 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Base.png?1690419436041", id:"Base"},
		{src:"images/BlueCar.png?1690419436041", id:"BlueCar"},
		{src:"images/BlueEVCar.png?1690419436041", id:"BlueEVCar"},
		{src:"images/DAS_Bushes.png?1690419436041", id:"DAS_Bushes"},
		{src:"images/DAS_OFF_Base.png?1690419436041", id:"DAS_OFF_Base"},
		{src:"images/DAS_ON_Bldg_top.png?1690419436041", id:"DAS_ON_Bldg_top"},
		{src:"images/DAS_ON_Glow.png?1690419436041", id:"DAS_ON_Glow"},
		{src:"images/DAS_ON_Inside.png?1690419436041", id:"DAS_ON_Inside"},
		{src:"images/DC_base_ON.png?1690419436041", id:"DC_base_ON"},
		{src:"images/DC_Ground.png?1690419436041", id:"DC_Ground"},
		{src:"images/DC_ON_bldg_top.png?1690419436041", id:"DC_ON_bldg_top"},
		{src:"images/DC_ON_Glow.png?1690419436041", id:"DC_ON_Glow"},
		{src:"images/Emergency_Outside_Front.png?1690419436041", id:"Emergency_Outside_Front"},
		{src:"images/Emergency_Responder_Ground.png?1690419436041", id:"Emergency_Responder_Ground"},
		{src:"images/ER_OFF_Bldg.png?1690419436041", id:"ER_OFF_Bldg"},
		{src:"images/ER_ON_bldg_shadow.png?1690419436041", id:"ER_ON_bldg_shadow"},
		{src:"images/ER_ON_GLOW.png?1690419436041", id:"ER_ON_GLOW"},
		{src:"images/ER_ON_RED_GLOW.png?1690419436041", id:"ER_ON_RED_GLOW"},
		{src:"images/ER_Trees_Back.png?1690419436041", id:"ER_Trees_Back"},
		{src:"images/EV_Base.png?1690419436041", id:"EV_Base"},
		{src:"images/EV_ON_Glow.png?1690419436041", id:"EV_ON_Glow"},
		{src:"images/EV_ON_Shadow.png?1690419436041", id:"EV_ON_Shadow"},
		{src:"images/EV_ON_Station.png?1690419436041", id:"EV_ON_Station"},
		{src:"images/EV_ON_Station_Glow.png?1690419436041", id:"EV_ON_Station_Glow"},
		{src:"images/Firetruck.png?1690419436042", id:"Firetruck"},
		{src:"images/GreenCar.png?1690419436042", id:"GreenCar"},
		{src:"images/House_1_on.png?1690419436042", id:"House_1_on"},
		{src:"images/House_1_plants.png?1690419436042", id:"House_1_plants"},
		{src:"images/House_2_on.png?1690419436042", id:"House_2_on"},
		{src:"images/House_3_on.png?1690419436042", id:"House_3_on"},
		{src:"images/Houses_Ground.png?1690419436042", id:"Houses_Ground"},
		{src:"images/Houses_ON_Glow.png?1690419436042", id:"Houses_ON_Glow"},
		{src:"images/houses_shad_1.png?1690419436042", id:"houses_shad_1"},
		{src:"images/houses_shad_2.png?1690419436042", id:"houses_shad_2"},
		{src:"images/houses_shad_3.png?1690419436042", id:"houses_shad_3"},
		{src:"images/Houses_Trees_4.png?1690419436042", id:"Houses_Trees_4"},
		{src:"images/Houses_Trees_5.png?1690419436042", id:"Houses_Trees_5"},
		{src:"images/HVAC_glow_on.png?1690419436042", id:"HVAC_glow_on"},
		{src:"images/HVAC_ON_BASE.png?1690419436042", id:"HVAC_ON_BASE"},
		{src:"images/HVAC_TOP_ANIMATION.png?1690419436042", id:"HVAC_TOP_ANIMATION"},
		{src:"images/Powerlines_OFF.png?1690419436042", id:"Powerlines_OFF"},
		{src:"images/Powerlines_OFF_ON.png?1690419436042", id:"Powerlines_OFF_ON"},
		{src:"images/Powerlines_ON_single_spark.png?1690419436042", id:"Powerlines_ON_single_spark"},
		{src:"images/street_light_1.png?1690419436042", id:"street_light_1"},
		{src:"images/street_light_2.png?1690419436042", id:"street_light_2"},
		{src:"images/street_light_3.png?1690419436042", id:"street_light_3"},
		{src:"images/street_light_4.png?1690419436042", id:"street_light_4"},
		{src:"images/street_light_5.png?1690419436042", id:"street_light_5"},
		{src:"images/SUV.png?1690419436042", id:"SUV"},
		{src:"images/traffic_light_1.png?1690419436042", id:"traffic_light_1"},
		{src:"images/traffic_light_2.png?1690419436042", id:"traffic_light_2"},
		{src:"images/traffic_light_3.png?1690419436042", id:"traffic_light_3"},
		{src:"images/WW_OFF_Bldg.png?1690419436042", id:"WW_OFF_Bldg"},
		{src:"images/WW_ON_Glow.png?1690419436042", id:"WW_ON_Glow"}
	],
	preloads: []
};
